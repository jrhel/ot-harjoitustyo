...
| 28.4  | 2         | Ratkoin bugin reseptin tallentamisessa tietokantaan. (Yllämainittu "LinkageError" häipyi itsestään(??).) Lisäsin toiminnon tallennettujen reseptien listaamiseksi.
| yht   | 41       |
