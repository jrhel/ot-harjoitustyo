...
| 7.4   | 4        | Koodasin tietokantayhteyden ja tarvittavien tietokantataulujen olemassaolon tarkistus/luonti ennen käyttöliittymän käynnistämistä, ja alustin sovelluslogiikan metodeilla alustaa ja tyhjentää tietokanta. Jostakin syystä en saa viiteavaimia toimimaan. Todennäköisesti en ehdi ratkoa sitä tänään ennen tämän päivän määräajan.
| yht   | 22       |
